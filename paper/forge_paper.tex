...
\begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth]{process_map.png}
      \caption{Overview of the plant layout and process flow}
\end{figure}
