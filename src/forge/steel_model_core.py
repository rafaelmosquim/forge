...
the user picks exactly one. Can be done via prompt, but app UI is more intuitive.
...
def calculate_lci(
    ...
    recipes,
    energy_balance=None,
    electricity_internal_fraction=None,
    gas_internal_fraction=None,
    ...
    Args:
        prod_level: Mapping of process name to number of runs solved by the material balance.
        recipes: Iterable of Process objects holding per-run material inputs/outputs.
    ...
    Returns:
        ...
        [Process, Output, Flow, Input, Category, ValueUnit, Amount, Unit].
